...
const PresentationCard = () => {
  return (
    <section id="home" className="navigation_section ">
      <div className="overflow-hidden relative shadow-lg shadow-gray-950 rounded-3xl flex flex-col items-center text-center pb-8 pt-6 px-5 xl:h-[calc(100vh-160px)] xl:fixed xl:w-1/4">
        <video
